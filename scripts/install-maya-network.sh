...
appPath="/private/tmp/Install Maya ${year}.app"
LOG="/var/log/maya_install.log"

echo "=== Maya 2026 Installation Started: $(date) ===" >> "$LOG"
...
# Step 2: Run silent installer for Maya
echo "Installing Maya via silent installer..." >> "$LOG"
...
echo "=== Maya 2026 Installation Complete: $(date) ===" >> "$LOG"
exit 0